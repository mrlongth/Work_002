<%@ Page Language="C#" MasterPageFile="~/Site_person.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="global_payment_special_slip.aspx.cs" Inherits="myWeb.Person_Manage.global_payment_special_slip"
    ...
    <center>
        <table cellpadding="1" cellspacing="1" style="width: 700px" border="0">
            ...
            <tr>
                ...
                <td width="5%">
                    <asp:DropDownList runat="server" CssClass="textbox" ID="cboPay_Semeter" AutoPostBack="True" OnSelectedIndexChanged="cboPay_Semeter_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
                <td style="text-align: right" width="15%">
