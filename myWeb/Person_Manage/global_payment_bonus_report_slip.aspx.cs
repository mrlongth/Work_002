...
namespace myWeb.Person_Manage
{
    ...
    public partial class global_payment_bonus_report_slip : GlobalPageBase
    {
        ...
        private void Retive_Rep_payment_slip()
        {
            try
            {
                ...
                if (this.mydsC == null)
                {
                    if (!oPayment_bonus.SP_PAYMENT_BONUS_DETAIL_SEL(ViewState["criteriaC"].ToString(), ref dsC, ref strMessage))
                    {
                ...
                if (this.mydsD == null)
                {
                    if (!oPayment_bonus.SP_PAYMENT_BONUS_DETAIL_SEL(ViewState["criteriaD"].ToString(), ref dsD, ref strMessage))
                    {
                        lblError.Text = strMessage;
                    }
                    else
                ...
                if (this.myds == null)
                {
                    if (!oPayment_bonus.SP_PAYMENT_BONUS_HEAD_SEL(Session["criteria"].ToString(), ref ds, ref strMessage))
                    {
                        lblError.Text = strMessage;
                    }
                    else
