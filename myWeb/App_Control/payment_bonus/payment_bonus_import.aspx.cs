...
{
    public partial class payment_bonus_import : PageBase
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                imgList_item.Attributes.Add("onclick", "OpenPopUp('750px','400px','93%','ค้นหาข้อมูลเงินรางวัล' ,'../lov/item_lov.aspx?year='+document.forms[0]." + strPrefixCtr +
                              ...
                              "'&ctrl1=" + txtitem_code.ClientID + "&ctrl2=" + txtitem_name.ClientID + "&item_type=D&from=payment_bonus&is_bonus=1', '1');return false;");
        ...
        protected void imgImport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            strScript = "OpenPopUp('500px','200px','80%','อัพโหลด Excel File เงินรางวัล' ,'payment_bonus_excel_upload.aspx?" +
