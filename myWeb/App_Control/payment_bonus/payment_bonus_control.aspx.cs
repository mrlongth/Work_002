...
{
    public partial class payment_bonus_control : PageBase
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ViewState["sort"] = "bn_payment_item_money";
                ...
                imgList_item.Attributes.Add("onclick", "OpenPopUp('900px','500px','94%','ค้นหาข้อมูลบุคลากร' ,'../lov/person_lov.aspx?" +
                     "from=payment_bonus_control&person_code='+getElementById('" + txtperson_code.ClientID + "').value+'" +
        ...
        private bool saveData()
        {
            ...
            try
            {
                ...
                {
                    #region insert
                    if (!oPayment_bonus.SP_PAYMENT_BONUS_HEAD_INS(strpayment_doc, txtpayment_date.Text, cboYear.SelectedValue, cboPay_Month.SelectedValue,
                        cboPay_Year.SelectedValue,  cboPay_Item.SelectedValue,  txtperson_code.Text, cboPerson_group.SelectedValue, txtbudget_plan_code.Text, "0", "0", "0", strcomments, "O",
                ...
                {
                    #region update
                    if (!oPayment_bonus.SP_PAYMENT_BONUS_HEAD_UPD(strpayment_doc, txtpayment_date.Text, cboYear.SelectedValue, cboPay_Month.SelectedValue,
            ...
            try
            {
                ...
                else
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        strpayment_recv = ds.Tables[0].Rows[0]["bn_payment_recv"].ToString();
                        strpayment_pay = ds.Tables[0].Rows[0]["bn_payment_pay"].ToString();
                        strpayment_net = ds.Tables[0].Rows[0]["bn_payment_net"].ToString();
                        ...
                        strperson_group = ds.Tables[0].Rows[0]["bn_person_group_code"].ToString();
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType.Equals(DataControlRowType.Header))
            {
                ...
                imgAdd.Attributes.Add("onclick", "OpenPopUp('800px','325px','94%','เพิ่มข้อมูลรายการเงินรางวัล','payment_bonus_item_control.aspx?mode=add&person_code=" +
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','325px','94%','แก้ไขข้อมูลรายการเงินรางวัล','payment_bonus_item_control.aspx?mode=edit&payment_doc=" +
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            var hddbn_payment_detail_id = (HiddenField)GridView1.Rows[e.RowIndex].FindControl("hddbn_payment_detail_id");
            var oPayment_bonus = new cPayment_bonus();
            try
            {
                if (!oPayment_bonus.SP_PAYMENT_BONUS_DETAIL_DEL(hddbn_payment_detail_id.Value, strUpdatedBy, ref strMessage))
                {
                    lblError.Text = strMessage;
                }
            }
        ...
        protected void cboPerson_group_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cboPerson_group.SelectedValue != "08")
            {
                imgList_item.Attributes.Add(
                    ...
                    + "from=payment_bonus_control&person_code='+getElementById('" + txtperson_code.ClientID
