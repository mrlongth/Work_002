...
{
    public partial class item_acc_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','เพิ่มข้อมูลบัญชี','item_acc_control.aspx?mode=add&page=0','1');return false;");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                Label lblitem_acc_code = (Label)e.Row.FindControl("lblitem_acc_code");
                Label lblitem_acc_name = (Label)e.Row.FindControl("lblitem_acc_name");
                Label lblc_active = (Label)e.Row.FindControl("lblc_active");
                HiddenField hdditem_acc_id = (HiddenField)e.Row.FindControl("hdditem_acc_id");
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','แสดงข้อมูลบัญชี','item_acc_view.aspx?item_acc_code=" + lblitem_acc_code.Text + "','1');return false;");
                ...
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','แก้ไขข้อมูลบัญชี','item_acc_control.aspx?mode=edit&item_acc_id=" + hdditem_acc_id.Value.ToString()   +
                ...
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบบัญชี   " + lblitem_acc_code.Text + " : " + lblitem_acc_name.Text + " ?\");");
                #endregion
