...
{
    public partial class person_manage_list : PageBase
    {
        #region private data
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','เพิ่มข้อมูลตำแหน่งการบริหาร','person_manage_control.aspx?mode=add&page=0','1');return false;");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                if (strStatus.Equals("Y"))
                {
                    ...
                    imgStatus.Attributes.Add("person_manage", ((DataSet)Application["xmlconfig"]).Tables["imgStatus"].Rows[0]["title"].ToString());
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','แสดงข้อมูลตำแหน่งทางการบริหาร','person_manage_view.aspx?mode=view&person_manage_code=" +
                                                 lblperson_manage_code.Text + "','1');return false;");
                imgView.ImageUrl = ((DataSet)Application["xmlconfig"]).Tables["imgView"].Rows[0]["img"].ToString();
                imgView.Attributes.Add("person_manage", ((DataSet)Application["xmlconfig"]).Tables["imgView"].Rows[0]["title"].ToString());
                #endregion
                ...
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','เพิ่มข้อมูลตำแหน่งทางการบริหาร','person_manage_control.aspx?mode=edit&person_manage_code=" + 
                                                lblperson_manage_code.Text + "&page=" + GridView1.PageIndex.ToString() + "&canEdit=Y','1');return false;");
                imgEdit.ImageUrl = ((DataSet)Application["xmlconfig"]).Tables["imgEdit"].Rows[0]["img"].ToString();
                imgEdit.Attributes.Add("person_manage", ((DataSet)Application["xmlconfig"]).Tables["imgEdit"].Rows[0]["title"].ToString());

                ImageButton imgDelete = (ImageButton)e.Row.FindControl("imgDelete");
                imgDelete.ImageUrl = ((DataSet)Application["xmlconfig"]).Tables["imgDelete"].Rows[0]["img"].ToString();
                imgDelete.Attributes.Add("person_manage", ((DataSet)Application["xmlconfig"]).Tables["imgDelete"].Rows[0]["title"].ToString());
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบยุทธศาสตร์การจัดสรรงบประมาณ   " + lblperson_manage_code.Text + " : " + lblperson_manage_name.Text + " ?\");");
        ...
        protected void GridView1_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.Pager))
            {
                ...
                imgGo.Attributes.Add("person_manage", ((DataSet)Application["xmlconfig"]).Tables["imgGo"].Rows[0]["title"].ToString());
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            Label lblperson_manage_code = (Label)GridView1.Rows[e.RowIndex].FindControl("lblperson_manage_code");
            cPerson_manage operson_manage = new cPerson_manage();
            try
            {
                if (!operson_manage.SP_PERSON_MANAGE_DEL(lblperson_manage_code.Text, "N", strUpdatedBy, ref strMessage))
                {
