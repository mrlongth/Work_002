<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" AutoEventWireup="true"
    CodeBehind="member_type_view.aspx.cs" Inherits="myWeb.App_Control.member_type.member_type_view" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr align="left">
            ...
            <td align="left" colspan="2" nowrap valign="top">
                &nbsp;<asp:TextBox ID="txtmember_type_code" runat="server" CssClass="textboxdis"
        ...
        <tr align="left">
            ...
            <td align="left" colspan="2" nowrap valign="top">
                <font face="Tahoma">&nbsp;<asp:TextBox ID="txtmember_type_name" runat="server" CssClass="textboxdis"
        ...
        <tr align="left">
            <td align="right" nowrap valign="top">
                <asp:Label ID="Label13" runat="server">เปอร์เซ็นต์ :</asp:Label>
            </td>
            <td align="left" colspan="2" nowrap valign="top">
                &nbsp;<asp:TextBox ID="txtmember_type_rate" runat="server" CssClass="numberdis"
                    MaxLength="6"   Width="144px" ValidationGroup="A">0.00</asp:TextBox>
            </td>
        </tr>
        <tr align="left">
            <td align="right" nowrap valign="top">
