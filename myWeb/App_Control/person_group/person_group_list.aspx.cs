...
{
    public partial class person_group_list : PageBase
    {
        #region private data
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgEdit.Attributes.Add("person_group", ((DataSet)Application["xmlconfig"]).Tables["imgEdit"].Rows[0]["title"].ToString());
                ...
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบแผนงาน   " + lblperson_group_code.Text + " : " + lblperson_group_name.Text + " ?\");");
                #endregion
        ...
        protected void GridView1_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.Pager))
            {
                ...
                imgGo.Attributes.Add("person_group", ((DataSet)Application["xmlconfig"]).Tables["imgGo"].Rows[0]["title"].ToString());
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            Label lblperson_group_code = (Label)GridView1.Rows[e.RowIndex].FindControl("lblperson_group_code");
