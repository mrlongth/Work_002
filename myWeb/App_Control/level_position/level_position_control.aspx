<%@ Page Language="C#" 
    ...
    CodeBehind="level_level_position_control.aspx.cs"
     Inherits="myWeb.App_Control.level_position.level_position_control" %>
    ...
    <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
        <tr align="left">
            <td align="right" nowrap >
                ...
                <asp:Label runat="server" ID="lblFName">รหัสระดับตำแหน่ง :</asp:Label>
            </td>
            <td align="left" colspan="2" nowrap >
                <asp:TextBox ID="txtlevel_position_code" runat="server" CssClass="textbox" MaxLength="5"
        ...
        <tr align="left">
            <td align="right" nowrap >
                ...
                <asp:Label ID="Label11" runat="server">ระดับตำแหน่ง :</asp:Label>
            </td>
            <td align="left" colspan="2" nowrap >
                <font face="Tahoma"><asp:TextBox ID="txtlevel_position_name" runat="server" CssClass="textbox"
        ...
        <tr align="left">
            ...
            <td align="right" nowrap  style="text-align: left">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtlevel_position_code"
                    Display="None" ErrorMessage="กรุณาป้อนรหัสระดับตำแหน่ง" 
                    ValidationGroup="A" SetFocusOnError="True"></asp:RequiredFieldValidator>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtlevel_position_name"
                    Display="None" ErrorMessage="กรุณาป้อนระดับตำแหน่ง" ValidationGroup="A" 
