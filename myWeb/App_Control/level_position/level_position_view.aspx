<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" AutoEventWireup="true"
    CodeBehind="level_level_position_view.aspx.cs" Inherits="myWeb.App_Control.level_position.level_position_view" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr align="left">
            ...
            <td align="left" colspan="2" nowrap valign="top">
                &nbsp;<asp:TextBox ID="txtlevel_position_code" runat="server" CssClass="textboxdis" MaxLength="100"
        ...
        <tr align="left">
            ...
            <td align="left" colspan="2" nowrap valign="top">
                <font face="Tahoma">&nbsp;<asp:TextBox ID="txtlevel_position_name" runat="server" CssClass="textboxdis"
