<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" AutoEventWireup="true"
    CodeBehind="level_level_position_list.aspx.cs" Inherits="myWeb.App_Control.level_position.level_position_list"
    Title="แสดงข้อมูลระดับตำแหน่ง" %>
    ...
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        <tr>
            ...
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="200px" ID="txtlevel_position_code"></asp:TextBox>
        ...
        <tr>
            ...
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="499px" ID="txtlevel_position_name"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: right;">
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <asp:GridView ID="GridView1" runat="server" CssClass="stGrid" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="ระดับตำแหน่ง " SortExpression="level_position_name">
                <ItemTemplate>
