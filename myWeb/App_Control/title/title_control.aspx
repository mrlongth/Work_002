<%@ Page Language="C#" 
    ...
    CodeBehind="title_control.aspx.cs"
     Inherits="myWeb.App_Control.title.title_control" %>
    ...
    <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
        <tr align="left">
            ...
            <td align="left" colspan="2" nowrap valign="top">
                <asp:TextBox ID="txttitle_code" runat="server" CssClass="textbox" MaxLength="5"
        ...
        <tr align="left">
            ...
            <td align="left" colspan="2" nowrap valign="top">
                <font face="Tahoma"><asp:TextBox ID="txttitle_name" runat="server" CssClass="textbox"
        ...
        <tr align="left">
            <td align="right" nowrap valign="top" style="height: 25px">
                &nbsp;</td>
            <td align="left" colspan="2" nowrap valign="top" style="height: 25px">
                &nbsp;</td>
        ...
        <tr align="left">
            ...
            <td align="right" nowrap valign="top" style="text-align: left">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txttitle_code"
                    Display="None" ErrorMessage="กรุณาป้อนรหัสคำนำหน้าชื่อ" 
                ...
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txttitle_name"
                    Display="None" ErrorMessage="กรุณาป้อนคำนำหน้าชื่อ" ValidationGroup="A" 
