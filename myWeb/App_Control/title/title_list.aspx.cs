...
{
    public partial class title_list : PageBase
    {
        #region private data
        ...
        //private string strPrefixCtr2 = "ctl00$ASPxRoundPanel1$ASPxRoundPanel2$ContentPlaceHolder2$";
        #endregion
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                Label lbltitle_code = (Label)e.Row.FindControl("lbltitle_code");
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%' , 'แสดงข้อมูลคำนำหน้าชื่อ' , 'title_view.aspx?mode=view&title_code=" + lbltitle_code.Text + "' , '1');return false;");
                ...
                string strTitle = "แสดงข้อมูลคำนำหน้าชื่อ" ;
                string strURL =  "title_control.aspx?mode=edit&title_code=" + lbltitle_code.Text   + "&page=" + GridView1.PageIndex.ToString() + "&canEdit=Y"  ;
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','" +strTitle +"' ,'" + strURL + "', '1');return false;");
