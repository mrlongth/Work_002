...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="1" cellspacing="1" style="width: 100%" border="0">
        <tr>
            ...
            <td rowspan="5" style="text-align: right; vertical-align: bottom; width: 15%;">
        ...
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblperson_name">รหัสบุคลากร :</asp:Label>
            </td>
            <td>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <asp:GridView ID="GridView1" runat="server" CssClass="stGrid" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="เลขที่เอกสาร" SortExpression="mc_payment_doc">
                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="True" />
                <ItemTemplate>
                    <asp:Label ID="lblpayment_doc" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.mc_payment_doc") %>'>
                    </asp:Label>
                </ItemTemplate>
            </asp:TemplateField>

            <asp:TemplateField HeaderText="วันที่" SortExpression="payment_date" Visible="false">
                <ItemStyle HorizontalAlign="Center" Width="10%" Wrap="True" />
                <ItemTemplate>
                    <cc1:AwLabelDateTime ID="lblpayment_date" runat="server" Value='<% # DataBinder.Eval(Container, "DataItem.payment_date") %>' DateFormat="dd/MM/yyyy">
                    </cc1:AwLabelDateTime>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="รหัสบุคลากร " SortExpression="person_code">
                ...
                <ItemTemplate>
                    <asp:Label ID="lblperson_code" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.mc_person_code") %>'>
                    </asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
