<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment_medical_excel_upload.aspx.cs"
    Inherits="myWeb.App_Control.payment_medical.payment_medical_excel_upload" %>
...
<head runat="server">
    ...
    <title>Upload Excel เงินค่าสวัสดิการข้าราชการ/ลูกจ้างประจำ</title>
    <style type="text/css">
