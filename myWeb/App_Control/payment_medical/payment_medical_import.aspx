    ...
    <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
        <tr align="left">
            ...
            <td align="left" nowrap valign="middle" colspan="4">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" BorderWidth="0px" CellPadding="0"
                    ...
                    <asp:ListItem Value="I" Selected="True">นำเข้าเงินค่าสวัสดิการข้าราชการ/ลูกจ้างประจำ</asp:ListItem>
                </asp:RadioButtonList>
        ...
        <tr align="left">
            <td align="right" nowrap valign="middle" width="20%">
                ...
                <asp:Label runat="server" ID="Label11">รหัสเงินค่าสวัสดิการข้าราชการ/ลูกจ้างประจำ :</asp:Label>
            </td>
    ...
    <asp:GridView runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="2"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="ชื่อ" SortExpression="person_thai_name">
                ...
                <ItemTemplate>
                    <asp:Label ID="lblperson_name" runat="server" Text='<%  # DataBinder.Eval(Container, "DataItem.mc_person_name")%>'>
                    </asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="นามสกุล" SortExpression="person_thai_surname">
                <ItemStyle HorizontalAlign="Left" Width="12%" Wrap="True" />
                <ItemTemplate>
                    <asp:Label ID="lblperson_thai_surname" runat="server" Text='<% # DataBinder.Eval(Container, "DataItem.mc_person_surname")%>'>
                    </asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
