    ...
    public partial class payment_medical_import : PageBase
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                imgList_item.Attributes.Add("onclick", "OpenPopUp('750px','400px','93%','ค้นหาข้อมูลค่ารักษาพยาบาล' ,'../lov/item_lov.aspx?year='+document.forms[0]." + strPrefixCtr +
                              ...
                              "'&ctrl1=" + txtitem_code.ClientID + "&ctrl2=" + txtitem_name.ClientID + "&item_type=D&from=payment_medical&is_special=1', '1');return false;");
        ...
        {
            var opayment_medical_round = new cpayment_medical_round();
            var ds = new DataSet();
            ...
            try
            {
                ...
                if (!opayment_medical_round.SP_payment_medical_ROUND_SEL(strCriteria, ref ds, ref strMessage))
                {
            ...
            {
                opayment_medical_round.Dispose();
            }
        }
        ...
        private bool saveData()
        {
            ...
            try
            {
                ...
                for (i = 0; i <= GridView1.Rows.Count - 1; i++)
                {
                    ...
                    {
                        if (!opayment_medical.SP_IMPORT_payment_medical_SAVE(hddsp_round_id.Value , lblperson_code.Text , hddunit_code.Value ,
        ...
        protected void imgImport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            strScript = "OpenPopUp('500px','200px','80%','อัพโหลด Excel File ค่าดำเนินงาน' ,'payment_medical_excel_upload.aspx?" +
                                                    "&ctrl1=" + hddGUID.ClientID +
                                                    "&item_code='+document.forms[0]." + strPrefixCtr + "txtitem_code.value+'" +
                                                    "&from=payment_medical" + cboYear.SelectedValue +
