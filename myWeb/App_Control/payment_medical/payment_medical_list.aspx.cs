...
{
    public partial class payment_medical_list : PageBase
    {
        ...
        private void BindGridView(int nPageNo)
        {
            ...
            {
                strCriteria = strCriteria + "  And  (mc_person_group_code='" + strPerson_group_code + "') ";
            }
            ...
            {
                strCriteria = strCriteria + "  And  (mc_person_code='" + strPerson_code + "') ";
            }
            ...
            {
                strCriteria = strCriteria + "  And  (mc_payment_doc like '" + strPayment_doc + "%') ";
            }
            ...
            //strCriteria += " and mc_person_group_code IN (" + PersonGroupList + ") ";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                if (!oPayment_medical.SP_PAYMENT_MEDICAL_HEAD_DEL(lblpayment_doc.Text, ref strMessage))
                {
                    lblError.Text = strMessage;
                }
            }
        ...
        protected void cboPerson_group_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                imgList_person.Attributes.Add("onclick", "OpenPopUp('900px','500px','94%','ค้นหาข้อมูลข้าราชการบำนาญ' ,'../lov/person_retire_lov.aspx?person_code='+document.forms[0]." + strPrefixCtr + "txtperson_code.value+" +
                   "'&person_name='+document.forms[0]." + strPrefixCtr + "txtperson_name.value+" +
                   "'&ctrl1=" + txtperson_code.ClientID + "&ctrl2=" + txtperson_name.ClientID + "', '1');return false;");
                imgClear_person.Attributes.Add("onclick", "document.getElementById('" + txtperson_code.ClientID + "').value='';document.getElementById('" + txtperson_name.ClientID + "').value=''; return false;");
