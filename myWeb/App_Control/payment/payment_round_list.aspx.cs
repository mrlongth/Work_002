...
{
    public partial class payment_round_list : PageBase
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','270px','90%','แสดงข้อมูลประมวลผลประจำเดือน','payment_round_view.aspx?mode=view&round_id=" +
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                if (!oPayment_round.SP_PAYMENT_ROUND_DEL(hdfround_id.Value, "N", strUpdatedBy, ref strMessage))
                {
                    lblError.Text = strMessage;
                }
            }
        ...
        protected void GridView1_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            try
            {
                if (!oPayment_round.SP_PAYMENT_ROUND_UPD(hdfround_id.Value, "C", strUpdatedBy, ref strMessage))
                {
                    lblError.Text = strMessage;
                }
            }
