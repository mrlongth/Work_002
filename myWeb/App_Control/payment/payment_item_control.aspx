                ...
                <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                    ...
                    <tr align="left">
                        ...
                        <td align="left" nowrap valign="middle">
                            <cc1:AwNumeric ID="txtamount" runat="server" CssClass="textbox" MaxValue="99999999" MinValue="-99999999" Width="100px"></cc1:AwNumeric>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtamount" Display="None" ErrorMessage="กรุณาป้อนจำนวนเงิน" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>
                        </td>
                        <td align="right" nowrap valign="middle">
                            <asp:Label ID="lblpayment_direct_pay" runat="server">จำนวนเงินจ่ายตรง :</asp:Label>
                        </td>
                        <td align="left" nowrap valign="middle">
                            <cc1:AwNumeric ID="txtpayment_direct_pay" runat="server" CssClass="textbox" MaxValue="99999999" MinValue="-99999999" Width="100px"></cc1:AwNumeric>
                        </td>
                    ...
                    <tr align="left">
                        ...
                        <td align="left" nowrap valign="middle">
                            <asp:TextBox ID="txtbudget_plan_code" runat="server" CssClass="textbox" MaxLength="10"
                                Width="80px"></asp:TextBox>&nbsp;<asp:ImageButton ID="imgList_budget_plan" runat="server" ImageAlign="AbsBottom"
