...
{
    public partial class payment_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('990px','550px','95%','เพิ่มข้อมูลการจ่ายเงินเดือน','payment_control.aspx?mode=add&page=0','1');return false;");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('990px','550px','95%','แสดงข้อมูลการจ่ายเงินเดือน','payment_view.aspx?mode=view&payment_doc=" +
                ...
                strScript = "OpenPopUp('990px','550px','95%','แก้ไขข้อมูลการจ่ายเงินเดือน','payment_control.aspx?mode=edit&payment_doc=" +
                                                                                                            lblpayment_doc.Text + "&page=" + GridView1.PageIndex.ToString() +
