<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" AutoEventWireup="true"
    CodeBehind="person_work_status_view.aspx.cs" Inherits="myWeb.App_Control.person_work_status.person_work_status_view" %>
        ...
        <tr align="left">
            ...
            <td align="left" colspan="2" nowrap valign="top">
                <font face="Tahoma">&nbsp;<asp:TextBox ID="txtperson_work_status_name" runat="server"
                    CssClass="textboxdis" MaxLength="100"   Width="344px" ReadOnly="True"></asp:TextBox>
                </font>
            </td>
