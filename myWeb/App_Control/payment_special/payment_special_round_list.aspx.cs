...
{
    public partial class payment_special_round_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           //Thread.Sleep(2000);
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('800px','350px','93%','บันทึกข้อมูลงวดการชำระภาคพิเศษ','payment_special_round_control.aspx?mode=add&page=0','1');return false;");
                if (chkRound())
                {
                ...
                ViewState["sort"] = "pay_year desc,pay_semeter desc,pay_item";
        ...
        private bool chkRound()
        {
            bool boolRetrun=false;
            cPayment_special_round oPayment_special_round = new cPayment_special_round();
        ...
        {         
            ...
            if (!strYear.Equals(""))
            {
                strCriteria = strCriteria + "  And  (pay_year = '" + strYear + "') ";
            } 
            try
            {
                if (!oPayment_special_round.SP_PAYMENT_SPECIAL_ROUND_SEL(strCriteria, ref ds, ref strMessage))
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                HiddenField hdfround_id = (HiddenField)e.Row.FindControl("hdfround_id");
                Label lblround_status = (Label)e.Row.FindControl("lblround_status");
                string strStatus = lblround_status.Text;

                #region set ImageStatus
                ImageButton imgRound_status = (ImageButton)e.Row.FindControl("imgRound_status");
                if (strStatus.Equals("O"))
                {
                    imgRound_status.ImageUrl = "../../images/controls/lock_unlock.png";
                    imgRound_status.Attributes.Add("title", "ปิดรอบจ่าย ณ ปัจจุบัน");
                    imgRound_status.Attributes.Add("onclick", "return confirm(\"คุณต้องการปิดรอบจ่าย ณ ปัจจุบัน หรือไม่ ?\");");
                ...
                {
                    imgRound_status.ImageUrl = "../../images/controls/lock.png";
                    imgRound_status.Attributes.Add("title", "รอบจ่ายที่ปิดแล้ว");
                    imgRound_status.Attributes.Add("onclick", "return false;");
                    imgRound_status.Enabled = false;
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','350px','93%','แสดงข้อมูลงวดการชำระภาคพิเศษ','payment_special_round_control.aspx?mode=view&round_id=" +
                                                                                                            hdfround_id.Value + "&page=0','1');return false;");
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            HiddenField hdfround_id = (HiddenField)GridView1.Rows[e.RowIndex].FindControl("hdfround_id");
            cPayment_special_round oPayment_special_round = new cPayment_special_round();
            try
            {
                if (!oPayment_special_round.SP_PAYMENT_SPECIAL_ROUND_DEL(hdfround_id.Value, "N", strUpdatedBy, ref strMessage))
                {
                    lblError.Text = strMessage;
                }
            }
        ...
        protected void GridView1_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            string strScript = string.Empty;
            string strUpdatedBy = Session["username"].ToString();
            HiddenField hdfround_id = (HiddenField)GridView1.Rows[e.NewEditIndex].FindControl("hdfround_id");
            cPayment_special_round oPayment_special_round = new cPayment_special_round();
            try
            {
                if (!oPayment_special_round.SP_PAYMENT_SPECIAL_ROUND_UPD(hdfround_id.Value, "C", strUpdatedBy, ref strMessage))
                {
                    lblError.Text = strMessage;
                }
            }
