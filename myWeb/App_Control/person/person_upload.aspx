<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="person_upload.aspx.cs"
    Inherits="myWeb.App_Control.person.person_upload" %>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right">
                                        <asp:Label runat="server" CssClass="label_hbk" ID="Label63">ไฟล์รูปภาพ :</asp:Label>
