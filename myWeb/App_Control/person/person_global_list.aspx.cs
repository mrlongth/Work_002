...
{
    public partial class person_global_list : PageBase
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.ToUpper().Equals("VIEW"))
            {
                ...
                Label lblperson_id = (Label)gvRow.FindControl("lblperson_id");
                _strMessage = string.Empty;
                if (SetPersonUserProfile(lblperson_id.Text,ref _strMessage)) 
                {
                    string strScript = "window.open(\"../../MainPerson.aspx\",\"_blank\")";
                    AddScriptBlock(strScript);
                }
                else
                {
        ...
        public void AddScriptBlock(string strScript)
        {
            UpdatePanel udpContent = (UpdatePanel)Page.Master.FindControl("updatePanel1");
            ScriptManager.RegisterClientScriptBlock(udpContent, udpContent.GetType(), "ScriptBlock", strScript, true);
        }
