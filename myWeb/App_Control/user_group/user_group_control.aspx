<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="user_group_control.aspx.cs" Inherits="myWeb.App_Control.user_group.user_group_control" %>
    ...
    <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
        <tr align="left">
            <td align="right" nowrap style="width: 20%">
                ...
                <asp:Label runat="server" ID="lblFName">รหัสกลุ่มผู้ใช้งาน :</asp:Label>
            </td>
            <td align="left" colspan="2" nowrap>
                <asp:TextBox ID="txtuser_group_code" runat="server" CssClass="textbox"
        ...
        <tr align="left">
            <td align="right" nowrap>
                ...
                <asp:Label ID="Label11" runat="server">กลุ่มผู้ใช้งาน :</asp:Label>
            </td>
            <td align="left" colspan="2" nowrap>
                <font face="Tahoma"><asp:TextBox ID="txtuser_group_name" runat="server"
