...
{
    public partial class user_group_list : PageBase
    {
        #region private data
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','เพิ่มข้อมูลกลุ่มผู้ใช้งาน','user_group_control.aspx?mode=add&page=0','1');return false;");
                ViewState["sort"] = "user_group_code";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                Label lbluser_group_code = (Label)e.Row.FindControl("lbluser_group_code");
                Label lbluser_group_name = (Label)e.Row.FindControl("lbluser_group_name");
                ...
                if (strStatus.Equals("Y"))
                {
                    ...
                    imgStatus.Attributes.Add("user_group", ((DataSet)Application["xmlconfig"]).Tables["imgStatus"].Rows[0]["title"].ToString());
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','แสดงข้อมูลกลุ่มผู้ใช้งาน','user_group_view.aspx?mode=view&user_group_code=" + 
                                                                lbluser_group_code.Text + "','1');return false;");
                imgView.ImageUrl = ((DataSet)Application["xmlconfig"]).Tables["imgView"].Rows[0]["img"].ToString();
                imgView.Attributes.Add("user_group", ((DataSet)Application["xmlconfig"]).Tables["imgView"].Rows[0]["title"].ToString());
                #endregion
                ...
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','แสดงข้อมูลกลุ่มผู้ใช้งาน','user_group_control.aspx?mode=edit&user_group_code=" + 
                                                                                lbluser_group_code.Text + "&page=" + GridView1.PageIndex.ToString() + "&canEdit=Y','1');return false;");
                imgEdit.ImageUrl = ((DataSet)Application["xmlconfig"]).Tables["imgEdit"].Rows[0]["img"].ToString();
                imgEdit.Attributes.Add("user_group", ((DataSet)Application["xmlconfig"]).Tables["imgEdit"].Rows[0]["title"].ToString());

                ImageButton imgDelete = (ImageButton)e.Row.FindControl("imgDelete");
                imgDelete.ImageUrl = ((DataSet)Application["xmlconfig"]).Tables["imgDelete"].Rows[0]["img"].ToString();
                imgDelete.Attributes.Add("user_group", ((DataSet)Application["xmlconfig"]).Tables["imgDelete"].Rows[0]["title"].ToString());
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบแผนงาน   " + lbluser_group_code.Text + " : " + lbluser_group_name.Text + " ?\");");
                #endregion
        ...
        protected void GridView1_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.Pager))
            {
                ...
                imgGo.Attributes.Add("user_group", ((DataSet)Application["xmlconfig"]).Tables["imgGo"].Rows[0]["title"].ToString());
