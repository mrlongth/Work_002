...
{
    public partial class member_list : PageBase
    {
        #region private data
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','เพิ่มข้อมูลเงินสมาชิก ','member_control.aspx?mode=add&page=0','1');return false;");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','แสดงข้อมูลเงินสมาชิก ','member_view.aspx?mode=view&member_code=" + 
                            lblmember_code.Text + "','1');return false;");
                imgView.ImageUrl = ((DataSet)Application["xmlconfig"]).Tables["imgView"].Rows[0]["img"].ToString();
                imgView.Attributes.Add("member", ((DataSet)Application["xmlconfig"]).Tables["imgView"].Rows[0]["title"].ToString());
                #endregion

                #region set Image Edit & Delete
                ImageButton imgEdit = (ImageButton)e.Row.FindControl("imgEdit");
                Label lblCanEdit = (Label)e.Row.FindControl("lblCanEdit");
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','แก้ไขข้อมูลเงินสมาชิก ','member_control.aspx?mode=edit&member_code=" + 
                            lblmember_code.Text + "&page=" + GridView1.PageIndex.ToString() + "&canEdit=Y','1');return false;");
                imgEdit.ImageUrl = ((DataSet)Application["xmlconfig"]).Tables["imgEdit"].Rows[0]["img"].ToString();
                imgEdit.Attributes.Add("member", ((DataSet)Application["xmlconfig"]).Tables["imgEdit"].Rows[0]["title"].ToString());

                ImageButton imgDelete = (ImageButton)e.Row.FindControl("imgDelete");
                imgDelete.ImageUrl = ((DataSet)Application["xmlconfig"]).Tables["imgDelete"].Rows[0]["img"].ToString();
                imgDelete.Attributes.Add("member", ((DataSet)Application["xmlconfig"]).Tables["imgDelete"].Rows[0]["title"].ToString());
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบประเภทเงินสมาชิก" + lblmember_code.Text + " : " + lblmember_name.Text + " ?\");");
                #endregion
        ...
        protected void GridView1_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.Pager))
            {
                ...
                imgGo.Attributes.Add("member", ((DataSet)Application["xmlconfig"]).Tables["imgGo"].Rows[0]["title"].ToString());
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            Label lblmember_code = (Label)GridView1.Rows[e.RowIndex].FindControl("lblmember_code");
            cMember oMember = new cMember();
            try
            {
                if (!oMember.SP_MEMBER_DEL(lblmember_code.Text, "N", strUpdatedBy, ref strMessage))
                {
