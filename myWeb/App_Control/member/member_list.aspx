<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" AutoEventWireup="true"
    CodeBehind="member_list.aspx.cs" Inherits="myWeb.App_Control.member.member_list"
    Title="แสดงข้อมูลเงินสมาชิก" %>
    ...
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        <tr>
            ...
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="200px" ID="txtmember_code"></asp:TextBox>
        ...
        <tr>
            ...
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="499px" ID="txtmember_name"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: right;">
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <asp:GridView ID="GridView1" runat="server" CssClass="stGrid" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="รหัสค่าใช้จ่าย" SortExpression="item_code">
                <ItemTemplate>
