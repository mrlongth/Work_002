...
namespace myWeb.App_Control.open
{
    public partial class open_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                imgList_open.Attributes.Add("onclick", "OpenPopUp('800px','400px','93%','ค้นหาข้อมูลรายการขออนุมัติเบิกจ่าย' ,'../lov/open_lov.aspx?" +
                                                    ...
                                                    "'&ctrl1=" + txtopen_code.ClientID + "&ctrl2=" + txtopen_title.ClientID + "&ctrl3=" + hddopen_id.ClientID + "', '1');return false;");
        ...
        private void BindGridView(int nPageNo)
        {
            ...
            {
                strCriteria = strCriteria + "  And  (budget_director_code ='" + strdirector_code + "') ";
            }

            if (!strunit_code.Equals(""))
            {
                strCriteria = strCriteria + "  And  (budget_unit_code ='" + strunit_code + "') ";
            }
            ...
            if (DirectorLock == "Y")
            {
                strCriteria += " and substring(budget_director_code,4,2) = substring('" + DirectorCode + "',4,2) ";
            }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgEdit.Attributes.Add("onclick", "OpenPopUp('950px','550px','95%','แก้ไข" + base.PageDes + "','open_control.aspx?budget_type=" + dv["budget_type"].ToString() + "&mode=edit&open_doc="
                                                            + dv["open_doc"].ToString() + "&page=" + GridView1.PageIndex.ToString() + "&canEdit=Y','1');return false;");
                ...
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบขออนุมัติเบิกจ่าย  : " + lblopen_doc.Text + " ?\");");
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                if (!oOpen.SP_OPEN_HEAD_DEL(hhdopen_head_id.Value, ref strMessage))
                {
                    lblError.Text = strMessage;
                }
            }
