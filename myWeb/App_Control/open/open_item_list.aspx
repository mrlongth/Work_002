<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="open_item_list.aspx.cs" Inherits="myWeb.App_Control.open.open_item_list"
    Title="แสดงข้อมูลรายการเบิกจ่าย" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" ID="lblPage9" CssClass="label_h">รหัสรายการ :</asp:Label>
            </td>
            <td style="width: 1%;">
        ...
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage18">หมวดรายได้/ค่าใช้จ่าย : </asp:Label>
            </td>
            <td colspan="3">
                <asp:DropDownList runat="server" AutoPostBack="False" CssClass="textbox" ID="cboItem_group">
                </asp:DropDownList>
            </td>
            <td rowspan="2">
                &nbsp;
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="No.">
                <ItemTemplate>
                    ...
                    <asp:HiddenField ID="hhdopen_id" runat="server" Value='<%# DataBinder.Eval(Container, "DataItem.open_id") %>' />
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="หัวข้อรายการ" SortExpression="open_title">
             ...
             <asp:TemplateField HeaderText="สำหรับ" SortExpression="open_remark">
