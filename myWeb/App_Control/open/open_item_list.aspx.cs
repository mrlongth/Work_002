...
namespace myWeb.App_Control.open
{
    public partial class open_item_list : PageBase
    {
        ...
        private void InitcboItem_group()
        {
            ...
            string stritem_group_year = ((DataSet)Application["xmlconfig"]).Tables["default"].Rows[0]["yearnow"].ToString();
        ...
        private void BindGridView(int nPageNo)
        {
            ...
            {
                strCriteria = strCriteria + "  And  (open_code ='" + stropen_code + "') ";
            }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                Label lblopen_code = (Label)e.Row.FindControl("lblopen_code");
                ...
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบรายการเบิกจ่าย  : " + lblopen_code.Text + " ?\");");
                #endregion
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            HiddenField hhdopen_id = (HiddenField)GridView1.Rows[e.RowIndex].FindControl("hhdopen_id");
            cOpen oOpen = new cOpen();
            try
            {
                if (!oOpen.SP_OPEN_DEL(hhdopen_id.Value,ref strMessage))
                {
                    lblError.Text = strMessage;
                }
            }
