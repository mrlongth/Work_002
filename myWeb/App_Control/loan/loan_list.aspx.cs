    ...
    public partial class loan_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('800px','300px','92%','เพิ่มข้อมูลเงินกู้','loan_control.aspx?mode=add&page=0','1');return false;");
                ViewState["sort"] = "loan_code";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','300px','92%' , 'แสดงข้อมูลเงินกู้' , 'loan_view.aspx?mode=view&loan_code=" + lblloan_code.Text + "' , '1');return false;");
                ...
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','300px','92%','แก้ไขข้อมูลเงินกู้' ,'loan_control.aspx?mode=edit&loan_code=" + lblloan_code.Text +
                ...
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบแผนงาน   " + lblloan_code.Text + " : " + lblloan_name.Text + " ?\");");
                #endregion
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            Label lblloan_code = (Label)GridView1.Rows[e.RowIndex].FindControl("lblloan_code");
            cLoan oLoan = new cLoan();
            try
            {
                if (!oLoan.SP_DEL_LOAN(lblloan_code.Text, "N", strUpdatedBy, ref strMessage))
                {
        ...
        private void BindGridView(int nPageNo)
        {
            ...
            string strloan_name = string.Empty;
            strloan_code = txtloan_code.Text.Replace("'", "''").Trim();
            strloan_name = txtloan_name.Text.Replace("'", "''").Trim();
            if (!strloan_code.Equals("0"))
            {
                strCriteria = strCriteria + "  And  (loan_code like '%" + strloan_code + "%') ";
            }
            if (!strloan_name.Equals("0"))
            {
                strCriteria = strCriteria + "  And  (loan_name like '%" + strloan_name + "%')";
            }
            try
            {
