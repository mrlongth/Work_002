...
namespace myWeb.App_Control.branch
{
    public partial class branch_list : PageBase
    {
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(branch_list));
            // Thread.Sleep(2000);
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('800px','460px','93%','เพิ่มข้อมูลสาขาธนาคาร','branch_control.aspx?mode=add&page=0','1');return false;");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%' , 'แสดงข้อมูลสาขาธนาคาร' , 'branch_view.aspx?branch_code=" + lblbranch_code.Text + "' , '1');return false;");
                ...
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','460px','93%' , 'แก้ไขข้อมูลสาขาธนาคาร' , 'branch_control.aspx?mode=edit&branch_code=" + lblbranch_code.Text +
