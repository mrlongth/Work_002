...
{
    public partial class payment_back_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.Title = "แสดง" + strpayment_back_title;
        ...
        private void BindGridView(int nPageNo)
        {
            ...
            strCriteria = strCriteria + "  And  (payment_back_type ='" + ViewState["payment_back_type"] + "') ";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                HiddenField hddpayment_back_id = (HiddenField)e.Row.FindControl("hddpayment_back_id");               
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('990px','550px','95%','แสดง" + strpayment_back_title + "','payment_back_view.aspx?mode=view&payment_back_id=" + hddpayment_back_id.Value +
                                        "&payment_back_type=" + ViewState["payment_back_type"].ToString()  + "&" +
                                        hddpayment_back_id.Value + "&page=" + GridView1.PageIndex.ToString() + "','1');return false;");
                ...
                lblperson_name.Text = "<a href=\"\" onclick=\"" +
                    "OpenPopUp('990px','550px','95%','แก้ไข" + strpayment_back_title + "','payment_back_control.aspx?mode=edit&payment_back_id=" +  hddpayment_back_id.Value +
                    "&payment_back_type=" + ViewState["payment_back_type"].ToString() + 
                    "&page=" + GridView1.PageIndex.ToString() + "','1');return false;\" >" + lblperson_name.Text + "</a>";


                ImageButton imgEdit = (ImageButton)e.Row.FindControl("imgEdit");
                imgEdit.Attributes.Add("onclick", "OpenPopUp('990px','550px','95%','แก้ไข" + strpayment_back_title + "','payment_back_control.aspx?mode=edit&payment_back_id=" + hddpayment_back_id.Value +
                     "&payment_back_type=" + ViewState["payment_back_type"].ToString() + 
                     "&page=" + GridView1.PageIndex.ToString() + "','1');return false;");
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            HiddenField hddpayment_back_id = (HiddenField)GridView1.Rows[e.RowIndex].FindControl("hddpayment_back_id");
            cPayment_back oPayment_back = new cPayment_back();
            try
            {
                if (!oPayment_back.SP_PAYMENT_BACK_HEAD_DEL(hddpayment_back_id.Value, ref strMessage))
                {
                    lblError.Text = strMessage;
                }
            }
