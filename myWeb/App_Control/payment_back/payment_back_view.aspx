<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="payment_back_view.aspx.cs" Inherits="myWeb.App_Control.payment_back.payment_back_view" %>
        ...
        <tr align="left">
            ...
            <td align="left" nowrap valign="middle">
                <asp:TextBox runat="server" CssClass="textboxdis"   Width="100px" 
                    ID="txtpayment_level_old"></asp:TextBox>
            </td>
            <td align="left" nowrap valign="middle" style="text-align: right">
            ...
            <td align="left" nowrap valign="middle">
                <asp:TextBox runat="server" CssClass="textboxdis"   Width="100px" 
                    ID="txtpayment_level_new"></asp:TextBox>
            </td>
        </tr>
        <tr align="left">
            <td align="right" nowrap valign="middle">
