...
{
    public partial class fund_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','เพิ่มข้อมูลกองทุนประจำปี','fund_control.aspx?budget_type=" + this.BudgetType + "&mode=add&page=0','1');return false;");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','เพิ่มข้อมูลกองทุนประจำปี','fund_view.aspx?budget_type=" + this.BudgetType + "&mode=view&fund_code=" + lblfund_code.Text + "','1');return false;");
                ...
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','แก้ไขข้อมูลกองทุนประจำปี','fund_control.aspx?budget_type=" + this.BudgetType + "&mode=edit&fund_code=" + 
                                                                lblfund_code.Text + "&page=" + GridView1.PageIndex.ToString() + "&canEdit=Y','1');return false;");
                ...
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบกองทุน   " + lblfund_code.Text + " : " + lblfund_name.Text + " ?\");");
                #endregion
