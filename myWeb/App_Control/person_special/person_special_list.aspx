<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="person_special_list.aspx.cs" Inherits="myWeb.App_Control.person.person_special_list"
    Title="แสดงข้อมูลอาจารย์พิเศษ" %>
    ...
    <asp:GridView ID="GridView1" runat="server" CssClass="stGrid" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="รหัสบุคลากร " SortExpression="sp_person_code">
                ...
                <ItemTemplate>
                    <asp:Label ID="lblsp_person_code" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.sp_person_code") %>'>
                    </asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
