<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" AutoEventWireup="true" CodeBehind="cheque_list.aspx.cs"
    Inherits="myWeb.App_Control.cheque.cheque_list" Title="แสดงข้อมูลเช็ค" %>    
    ...
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        <tr>
            ...
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="200px" ID="txtcheque_code"></asp:TextBox>
        ...
        <tr>
            ...
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="499px" ID="txtcheque_name"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: right;">
