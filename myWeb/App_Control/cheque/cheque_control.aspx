<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="cheque_control.aspx.cs" Inherits="myWeb.App_Control.cheque.cheque_control" %>
    ...
    <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
        <tr align="left">
            <td align="right" nowrap valign="top">
                ...
                <asp:Label runat="server" ID="lblFName">รหัสเช็ค :</asp:Label>
            </td>
            <td align="left" colspan="2" nowrap valign="top">
                <asp:TextBox ID="txtcheque_code" runat="server" CssClass="textbox" MaxLength="5"  
        ...
        <tr align="left">
            <td align="right" nowrap valign="top">
                ...
                <asp:Label ID="Label11" runat="server">ที่อยู่จ่ายเช็ค :</asp:Label>
            </td>
            <td align="left" colspan="2" nowrap valign="top">
                <font face="Tahoma">
                    <asp:TextBox ID="txtcheque_name" runat="server" CssClass="textbox" MaxLength="100"
        ...
        <tr align="left">
            <td align="right" nowrap valign="top">
                <asp:Label ID="Label73" runat="server">รายละเอียดจ่ายเช็ค :</asp:Label>
            </td>
            <td align="left" colspan="2" nowrap valign="top">
                <font face="Tahoma">
                    <asp:TextBox ID="txtcheque_desc" runat="server" CssClass="textbox" MaxLength="255"
                          Width="344px" CausesValidation="True" ValidationGroup="A" 
        ...
        <tr align="left">
            ...
            <td align="right" nowrap valign="top" style="text-align: left">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtcheque_code"
                    Display="None" ErrorMessage="กรุณาป้อนรหัสเช็ค" ValidationGroup="A" SetFocusOnError="True"></asp:RequiredFieldValidator>
                ...
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtcheque_name"
                    Display="None" ErrorMessage="กรุณาป้อนเช็ค" ValidationGroup="A" SetFocusOnError="True"></asp:RequiredFieldValidator>
