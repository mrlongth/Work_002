<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" AutoEventWireup="true"
    CodeBehind="cheque_view.aspx.cs" Inherits="myWeb.App_Control.cheque.cheque_view" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr align="left">
            ...
            <td align="left" nowrap valign="top">
                <asp:TextBox ID="txtcheque_code" runat="server" CssClass="textboxdis" MaxLength="100"
        ...
        <tr align="left">
            ...
            <td align="left" nowrap valign="top">
                <font face="Tahoma"><asp:TextBox ID="txtcheque_name" runat="server" CssClass="textboxdis"
