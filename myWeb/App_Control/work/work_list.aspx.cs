...
{
    public partial class work_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','เพิ่ม" + base.PageDes + "','work_control.aspx?budget_type=" + this.BudgetType + "&mode=add&page=0','1');return false;");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','แสดงข้อมูลงาน','work_view.aspx?budget_type=" + this.BudgetType + "&mode=view&work_code=" + lblwork_code.Text + "','1');return false;");
                ...
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','250px','90%','แก้ไข" + base.PageDes + "','work_control.aspx?budget_type=" + this.BudgetType + "&mode=edit&work_code=" + lblwork_code.Text +
                ...
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบงาน   " + lblwork_code.Text + " : " + lblwork_name.Text + " ?\");");
                #endregion
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            Label lblwork_code = (Label)GridView1.Rows[e.RowIndex].FindControl("lblwork_code");
            cWork oWork = new cWork();
            try
            {
                if (!oWork.SP_DEL_WORK(lblwork_code.Text, "N", strUpdatedBy, ref strMessage))
                {
                    lblError.Text = strMessage;
                }
            }
