<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" AutoEventWireup="true"
    CodeBehind="work_list.aspx.cs" Inherits="myWeb.App_Control.work.work_list" Title="แสดงข้อมูลงาน " %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" CssClass="textbox" Width="200px" ID="txtwork_code"></asp:TextBox>
                <asp:Label ID="lblError" runat="server" CssClass="label_error"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage1">ชื่องาน :
                </asp:Label>
            </td>
            <td>
                <asp:TextBox runat="server" CssClass="textbox" Width="499px" ID="txtwork_name"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: right;">
