...
{
    public partial class director_list : PageBase
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                Label lbldirector_code = (Label)e.Row.FindControl("lbldirector_code");
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','350px','90%','แสดงข้อมูลสังกัด','director_view.aspx?mode=view&director_code=" +
                                                                lbldirector_code.Text + "&page=0','1');return false;");
                ...
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบสังกัด   " + lbldirector_code.Text + " : " + lbldirector_name.Text + " ?\");");
                #endregion
