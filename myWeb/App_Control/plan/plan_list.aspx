<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" AutoEventWireup="true"
    CodeBehind="plan_list.aspx.cs" Inherits="myWeb.App_Control.plan.plan_list" Title="แสดงข้อมูลแผนงาน " %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" CssClass="textbox" Width="200px" ID="txtplan_code"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" CssClass="textbox" Width="499px" ID="txtplan_name"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: right;">
