...
{
    public partial class payment_return_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('990px','550px','95%','เพิ่มข้อมูลส่งเงินคืนคลัง','payment_return_control.aspx?mode=add&page=0','1');return false;");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('990px','550px','95%','แสดงข้อมูลส่งเงินคืนคลัง','payment_return_view.aspx?mode=view&payment_doc=" + lblpayment_doc.Text +
                ...
                lblperson_name.Text = "<a href=\"\" onclick=\"" +
                    "OpenPopUp('990px','550px','95%','แก้ไขข้อมูลส่งเงินคืนคลัง','payment_return_control.aspx?mode=edit&payment_doc=" + lblpayment_doc.Text +
                                                    "&page=" + GridView1.PageIndex.ToString() + "','1');return false;\" >" + lblperson_name.Text + "</a>";


                ImageButton imgEdit = (ImageButton)e.Row.FindControl("imgEdit");
                imgEdit.Attributes.Add("onclick", "OpenPopUp('990px','550px','95%','แก้ไขข้อมูลส่งเงินคืนคลัง','payment_return_control.aspx?mode=edit&payment_doc=" + lblpayment_doc.Text +
                                                    "&page=" + GridView1.PageIndex.ToString() + "','1');return false;");
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                if (!oPayment_return.SP_PAYMENT_RETURN_HEAD_DEL(lblpayment_doc.Text, ref strMessage))
                {
                    lblError.Text = strMessage;
                }
            }
