<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" AutoEventWireup="true" CodeBehind="budget_list.aspx.cs"
    Inherits="myWeb.App_Control.budget.budget_list" Title="แสดงข้อมูลแผนงาน " %>
    ...
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage2">รหัสแผนงาน :
                </asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage1">ชื่อแผนงาน : 
                </asp:Label>
            </td>
            <td>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <asp:GridView ID="GridView1" runat="server" CssClass="stGrid" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="รหัสแผนงาน " SortExpression="budget_code">
