<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="budget_control.aspx.cs" Inherits="myWeb.App_Control.budget.budget_control" %>
        ...
        <tr align="left">
            ...
            <td align="right" nowrap style="text-align: left" valign="top">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtbudget_name"
                    Display="None" ErrorMessage="กรุณาป้อนแผนงบประมาณ" ValidationGroup="A" 
